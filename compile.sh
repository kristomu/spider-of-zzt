...
g++ -shared -o zzt_interesting.so -fPIC src/zzt_interesting_python.cc -I/usr/include/libxml2/ -I/usr/include/python3.9/ -lpython3.9 -lboost_python39 -lxml2 -larchive -lmagic -O9
echo uriextract
